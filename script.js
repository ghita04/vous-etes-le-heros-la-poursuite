...
let chapterObj = {
  ...
  chapter5: {
    ...
    options: [
      {
        optionText: "Avez-vous en votre possession votre téléphone ?",
  ...
  chapter6: {
    ...
    options: [
      {
        optionText: "Vous décidez de marcher jusqu'à chez vous",
  ...
  pouce: {
    ...
    options: [
      {
        optionText: "Réussite ! Retour au menu principal",
        action: 'goToChapter("chapter1")',
      },
    ],
  },
